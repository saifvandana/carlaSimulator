...
class CarlaDataProvider:
    def __init__(self):
        ...
        self.destination = carla.Location(x=145, y=290, z=0)
        self.last_data = None
        ...
        self.route_signs = [
            {
                'location': carla.Location(x=-37.918865, y=160.933258, z=0.001767),
                'name': "eco-mode"
            },
            {
                'location': carla.Location(x=-206.008301, y=126.988533, z=-0.001098),
                'name': "crossing"
            },
            {
                'location': carla.Location(x=-84.106247, y=-71.430832, z=0.001710),
                'name': "distance-to-empty middle"
            },
            {
                'location': carla.Location(x=22.122339, y=399.638855, z=0.001722),
                'name': "washer-fluid-warning"
            },
        ]
        self.speed_points = [
            {
                'location': carla.Location(x=-37.429718, y=195.153732, z=0.001700),
                'name': "60"
            },
            {
                'location': carla.Location(x=-37.918865, y=160.933258, z=0.001767),
            ...
            {
                'location': carla.Location(x=-62.190899, y=128.060608, z=0.001710),
                'name': "60"
            },
            {
                'location': carla.Location(x=-104.363876, y=127.286552, z=0.001739),
                'name': "90"
            },
            {
                'location': carla.Location(x=-189.640976, y=127.054672, z=0.001729),
                'name': "60"
            },
            {
                'location': carla.Location(x=-206.008301, y=126.988533, z=-0.001098),
            ...
            {
                'location': carla.Location(x=-229.956329, y=213.395264, z=0.001724),
                'name': "30"
            },
            {
                'location': carla.Location(x=-83.057419, y=329.998871, z=0.001691),
                'name': "30"
            },
            {
                'location': carla.Location(x=-64.979904, y=334.405273, z=0.001725),
                'name': "50"
            },
            {
                'location': carla.Location(x=352.882690, y=588.614624, z=0.001753),
                'name': "90"
            },
            {
                'location': carla.Location(x=-84.106247, y=-71.430832, z=0.001710),
            ...
            {
                'location': carla.Location(x=158.525665, y=568.785583, z=0.001699),
                'name': "50"
            },
            {
                'location': carla.Location(x=398.429108, y=367.114990, z=0.001782),
                'name': "60"
            },
             {
                'location': carla.Location(x=421.665253, y=355.152740, z=0.001768),
                'name': "60"
            },
            {
                'location': carla.Location(x=445.312378, y=354.382446, z=0.001733),
                'name': "30"
            },
            {
                'location': carla.Location(x=540.706421, y=328.220123, z=0.001763),
                'name': "90"
            },
            {
                'location': carla.Location(x=542.067566, y=74.390984, z=-0.002170),
                'name': "60"
            },
            {
                'location': carla.Location(x=541.506653, y=57.777180, z=0.001779),
                'name': "30"
            },
            {
                'location': carla.Location(x=515.804260, y=20.738289, z=0.001697),
                'name': "30"
            },
        ]
        self.route_points = [
            {
                'location': carla.Location(x=-38.698704, y=253.327850, z=0.001769),
                'turn': 'straight',
                'name': "Start"
            },
            {
            ...
            {
                'location': carla.Location(x=-193.596283, y=217.146988, z=0.001801),
                'turn': 'right',
                'name': "SecondTurn"
            },
            {
                'location': carla.Location(x=-185.073944, y=327.519257, z=0.001746),
                'turn': 'left',
                'name': "ThirdTurn"
            },
             {
            ...
            },
             {
                'location': carla.Location(x=158.525665, y=568.785583, z=0.001699),
                'turn': 'right',
                'name': "sixthTurn"#exit highway
            },
             {
                'location': carla.Location(x=486.241547, y=23.316751, z=0.001706),
                'turn': 'left',
                'name': "seventhTurn"
            },
            {
                'location': carla.Location(x=477.441864, y=74.202805, z=0.001778),
                'turn': 'right',
                'name': "eigthTurn"
            },
            {
                'location': carla.Location(x=236.417419, y=83.666084, z=0.001767),
                'turn': 'left',
                'name': "ninthTurn"
            },
            {
                'location': carla.Location(x=240.716248, y=152.784103, z=0.001780),
                'turn': 'left',
                'name': "tenthTurn"
            },
            {
                'location': carla.Location(x=475.184021, y=158.298431, z=0.001710),
                'turn': 'right',
                'name': "eleventhTurn"
            },
            {
                'location': carla.Location(x=475.233337, y=215.274704, z=0.001769),
                'turn': 'right',
                'name': "twelveTurn"
            },
            {
                'location': carla.Location(x=237.862091, y=222.013992, z=0.001703),
                'turn': 'left',
                'name': "thirteenthTurn"
            },
            {
                'location': carla.Location(x=232.804840, y=338.176636, z=0.001772),
                'name': "Finish"
            }
        ]
    ...
    async def connect_to_carla(self, host='localhost', port=2000):
        ...
        try:
            ...
            self.vehicle = find_ego_vehicle(self.world)#, carla.Location(x=235, y=317, z=0))
            success = precise_respawn(self.vehicle, carla.Location(x=-38.698704, y=253.327850, z=0.001769), yaw=None)
            ...
            if progress_signs:
                if progress_signs['status'] == 'enroute':
                    if progress_signs['distance'] < 10: 
                        if progress_signs['name'] == "eco-mode":
                            self.shared_data["eco_mode"] = True
                            voice_alert("Check eco mode")
                        if progress_signs['name'] == "crossing":
                            voice_alert("Check crossing warning")
                            self.shared_data["warning_crossing_distance"] = int(progress_signs['distance'])
                        ...
                        if progress_signs['name'] == "washer-fluid-warning":
                            self.shared_data["washer_fluid_warning"] = True
                            voice_alert("Check washer fluid")
