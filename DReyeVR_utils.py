...
def find_ego_vehicle2(world, location):
    DReyeVR_vehicle = None
    vehicle_type='harplab.dreyevr_vehicle.teslam3'
    # blueprint_lib = world.get_blueprint_library()
    # bp = random.choice(blueprint_lib.filter(vehicle_type)) if vehicle_type \
    #             else random.choice(blueprint_lib.filter('harplab.dreyevr_vehicle.*'))
    bp = world.get_blueprint_library().find(vehicle_type)
